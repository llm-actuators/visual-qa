...
Add via SPM: `https://github.com/llm-actuators/idb.git`
...
|---------|--------------|---------|
| `{{fixtures.test_site.name}}` | `catalogue/fixtures.yaml` | "ExampleSite" |
...
See the TC authoring guide for the full 14 rules. The critical ones:
